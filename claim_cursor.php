        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
          <div class="card-body">
            <div class="text-center">
              ...
              <button type="button" class="btn my-2 btn-sm btn-outline-dark my-3 active">
                <a href="claim_req.php">Claim Requests</a>
              </button>
  ...
  <div class="col-md-9 mx-auto">
    ...
    <div class="text-center row shadow p-3 mb-5 bg-white rounded row align-items-center">
      <div class="col-md-4 offset-md-4">
        <h1><b>Claim Requests</b></h1>
      </div>

      <div class="input-group my-3 col-md-4 row justify-content-end">
        <a href="claim_req.php">  <i class="fa fa-chevron-circle-left" aria-hidden="true"></i></a>
      </div>
    ...
    <table class="table table-sm table-bordered shadow p-3 mb-5 bg-white rounded">
      ...
      <tbody>
        ...
        $_SESSION['Userid']=$result['User_I'];
            ...
            // $_SESSION['policy_cat']=$result['policy_cat'];
            // echo $_SESSION['policy_cat'];
          ?>
        <tr>
          ...
          <td class="text-center align-middle"><a href="approve_claim.php?id=<?php echo $result['User_I']; ?>">Approve</a></td>
        </tr>
        <?php
        }
        else
        {
          ...
          ?>
      <script>
        window.location.href = "claim_req.php";
      </script>
      <?php
        }      
