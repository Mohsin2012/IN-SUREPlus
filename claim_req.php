<?php  
  ...
  if(isset($_POST['search']))
  {
    ...
    header('location:claim_cursor.php');
  }
?>
    ...
    <table class="table table-sm table-bordered shadow p-3 mb-5 bg-white rounded">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center align-middle"><a href="approve_claim.php?id=<?php echo $result['userid']; ?>">Approve</a></td>
        </tr>
        <?php
        }
        ?>
