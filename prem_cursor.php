  ...
  <div class="col-md-9 mx-auto">
    ...
    <div class="text-center row shadow p-3 mb-5 bg-white rounded row align-items-center">
      ...
      <div class="input-group my-3 col-md-4 row justify-content-end">
        <a href="admin_pre_category_view.php"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i></a>
      </div>
    ...
    <table class="table table-sm table-bordered shadow p-3 mb-5 bg-white rounded">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center"><a href="update_pre_cat.php?id=<?php echo $result['Policy_N']; ?>"><i class="far fa-edit"></i></a>
          </td>
          <td class="text-center"><a href="delete_pre_cat.php?id=<?php echo $result['Policy_N']; ?>"><i class="far fa-trash-alt"></i></a></td>
        </tr>
