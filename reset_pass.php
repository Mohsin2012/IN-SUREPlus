...
if (isset($_POST['change_pass'])) {
    ...
    {
      $query = "UPDATE `login` SET `Password` = '$spassword' WHERE `login`.`Password` = '$pass';";
...
?>
  ...
  <div class="container">
    <div class="container px-5 col-md-4 my-4 shadow p-3 mb-5 bg-white rounded">
      <h2 id="heading" class="text-center mt-5" style="font-family: 'Ubuntu', sans-serif;">Reset Password</h2>
      <form action="" name="signupForm" method="post" id="login-form">
        ...
        <button name="change_pass" id="submitbtn" type="submit"
          class="btn btn-outline-dark container my-3">Update</button>
      </form>
    </div>
  </div>
