    ...
    <div class="col-md-7 mx-auto shadow p-3 mb-5 bg-white rounded">
      ...
      <form method="POST" action="">
        ...
        <?php
          ...
          $sq = "SELECT * FROM `norm_category` where Policy_no=$id"; 
          ...
          if(isset($_POST['Add']))
          {
            ...
            else
            {
              ...
              $sql = "UPDATE norm_category SET Policy_name='$policy_name',Policy_company='$policy_comp',Monthly_pay='$monthly',Total_year='$total',User_id='$user_id',Coverage='$coverage' WHERE Policy_no=$id";
